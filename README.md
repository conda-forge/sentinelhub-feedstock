...
Once the `conda-forge` channel has been enabled, `sentinelhub` can be installed with:

```
conda install sentinelhub
```

It is possible to list all of the versions of `sentinelhub` available on your platform with:
